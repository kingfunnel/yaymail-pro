...
class Shortcodes {
	...
	public function collectOrderData( $sent_to_admin = '', $args = array() ) {
		...
		// CUSTOM SHORTCODE
		$shortcode['[yaymail_dpdch_tracking_number]'] = $this->dpdch_tracking_number( '', $this->order, $sent_to_admin );
		...
		if ( ! empty( $order ) ) {
			foreach ( $order->get_meta_data() as $meta ) {
				...
				} else if ('_local_pickup_time_select' == $nameField) {
	...
	public function dpdch_tracking_number( $atts, $order, $sent_to_admin = '' ) {
		if ( null === $order ) {
